...
const upcomingPatients = [
  { time: "11:30", name: "Rosa Chávez", condition: "Ansiedad + HTA leve", deaf: true, type: "Teleconsulta", avatar: "RC", status: "next" },
  { time: "14:00", name: "Juan Paredes", condition: "Diabetes Tipo 2 — Seguimiento", deaf: false, type: "Seguimiento", avatar: "JP", status: "pending" },
  { time: "15:30", name: "Ana Morales", condition: "Control prenatal semana 28", deaf: true, type: "Teleconsulta", avatar: "AM", status: "pending" },
];
  ...
  return (
    <div className="p-6 space-y-6 anim-fade-in" style={{ background: "#F9FAFB", minHeight: "100vh" }}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 anim-fade-in-up anim-d-1">
        {[
          { label: "Consultas hoy", value: "8", icon: <Stethoscope size={18} />, bg: "#EEF2FF", color: "#203A70" },
          { label: "Completadas", value: "5", icon: <CheckCircle size={18} />, bg: "#DCFCE7", color: "#10B981" },
          { label: "Pendientes", value: "3", icon: <Clock size={18} />, bg: "#FEF3C7", color: "#D97706" },
          { label: "Telemedicina LSE", value: "2", icon: <Activity size={18} />, bg: "#F0FFFE", color: "#00A69D" },
        ].map((m, i) => (
            ...
            <div className="relative">
              <div className="flex items-center gap-2 mb-4">
                <span className="text-xs px-2.5 py-1 rounded-full" style={{ background: "rgba(255,255,255,0.15)", color: "white", fontWeight: 600 }}>
                  ...
                  Próximo paciente · {nextPatient.time} AM
                </span>
                {nextPatient.deaf && (
              ...
              {upcomingPatients.map((p, i) => (
                <div key={i} className="flex items-center gap-4 px-5 py-3.5">
                  ...
                  <div
                    ...
                    style={{ background: i === 0 ? "#00A69D" : "#203A70", fontWeight: 700 }}
                  >
                    {p.avatar}
                  </div>
